...
/**
 * Model class that implements all functionalities supported by the model like
 * blur, sharpen, greyscale, sepia tone, dither, mosaic, pixelation and
...
public class ImageProcessing implements Image {
	...
	public void pattern(int square, String saveName) {
		...
		pattern_pixels = pattern.getPattern_pixels();
		result = pattern.stichPattern(image, square, pattern_pixels);
	}
