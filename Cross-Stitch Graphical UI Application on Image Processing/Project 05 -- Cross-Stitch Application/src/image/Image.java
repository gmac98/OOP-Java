...
/**
 * Model of the program that implements functionalities offered by the program when prompted by the
 * controller.
 */
public interface Image {
  ...
  /**
   * Generate a low color density copy of the given image by applying Floyd Steinberg dithering
   * technique on it.
   *
  ...
  /**
   * Replaces one pixel color from the cross-stitch pattern with another pixel color.
   *
   * @param initialcolor exisiting pixel color in pattern
   * @param color new color to replace initial color
   */
