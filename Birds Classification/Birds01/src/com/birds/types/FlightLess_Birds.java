...
/**Flightless Birds class defines properties for flightless birds.
 */
public class FlightLess_Birds extends Birds {

  /**
   * Creates constructor for Flightless Birds to initialize its values.
  ...
  public String getDistinctFeature() {
    String features = "long, flexible beak with a downward curve on end";
    return features;
  }
  ...
  public List<String> getListOfLivingHabitats() {
    ...
    habitats.add("Madagascar");
    habitats.add("New Zealand");
